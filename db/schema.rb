...
ActiveRecord::Schema.define(version: 2020_09_20_095456) do
  ...
  create_table "lotto_numbers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.decimal "draw_probability", precision: 5, scale: 2, default: "0.0"
  ...
  create_table "rounds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["round"], name: "index_rounds_on_round", unique: true
  end
